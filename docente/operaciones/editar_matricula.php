...
while ($r_b_cursos = mysqli_fetch_array($b_cursos)) {
    ...
    if ($cont > 0) {
        ...
        // validamos que el estudiante no este matriculado a este curso para matricularlo
        $b_det_mat = buscar_detmatriculadosPorIdMatProg($conexion, $id_matricula, $id_curso_prog);
...
$consulta = "UPDATE matricula SET id_sede='$sede_m',id_nivel='$nivel_m',id_grado='$grado_m',id_turno='$turno_m',id_seccion='$seccion_m' WHERE id='$id_matricula'";
$ejecutar_consulta = mysqli_query($conexion, $consulta);


$consulta_est = "UPDATE estudiante SET id_sede='$sede_m' WHERE id='$id_est'";
$ejecutar_consulta = mysqli_query($conexion, $consulta_est);
