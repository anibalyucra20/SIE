                              ...
                              <div class="x_panel">
                                ...
                                <div class="x_content">
                                  ...
                                  <form role="form" action="operaciones/registrar_programacion_clases.php" class="form-horizontal form-label-left input_mask" method="POST">
                                    ...
                                    <div class="form-group">
                                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Nombre Sede: </label>
                                      <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="text" maxlength="150" class="form-control" name="nombre_sede" required="required">
                                        <br>
                                      </div>
                                    </div>
                                    <div align="center">
