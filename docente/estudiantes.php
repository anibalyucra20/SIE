                                                                                        ...
                                                                                        <form role="form" action="operaciones/editar_estudiante.php" class="form-horizontal form-label-left input_mask" method="POST">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <div class="row">
                                                                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Foto: </label>
                                                                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                                                                        <img src="<?php echo "../estudiante/".$r_b_estudiante['foto']; ?>" alt="" width="100px">
                                                                                                        <br>
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-md-3 col-sm-3 col-xs-6">
                                                                                                        <select class="form-control" name="editar_sede" id="sede" required>
                                                                                                            ...
                                                                                                            ?>
                                                                                                                <option value="<?php echo $r_b_sedes['id']; ?>" <?php if ($r_b_sedes['id'] == $r_b_estudiante['id_sede']) {
                                                                                                                                                                    echo "selected";
                                                                                                                                                                } ?>><?php echo $r_b_sedes['nombre']; ?></option>
                                                                                                            <?php
                                                                                                            }
                                                                                                            ?>
                                                                                                        </select>
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-md-3 col-sm-3 col-xs-6">
                                                                                                        <select class="form-control" name="editar_discapacidad" id="genero" required>
                                                                                                            <option value=""></option>
                                                                                                            <option value="1" <?php if ($r_b_estudiante['discapacidad'] == 1) {
                                                                                                                                    echo "selected";
                                                                                                                                } ?>>Si</option>
                                                                                                            <option value="0" <?php if ($r_b_estudiante['discapacidad'] == 0) {
                                                                                                                                    echo "selected";
                                                                                                                                } ?>>No</option>
                                                                                                        </select>
                                                                                                        <br>
