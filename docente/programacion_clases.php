                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><button type="button" class="btn btn-success" data-toggle="modal" data-target=".editar<?php echo $rb_cursos_programados['id']; ?>">Editar</button></td>
                                                                </tr>
                                                                <!--MODAL EDITAR-->
                                                                <div class="modal fade editar<?php echo $rb_cursos_programados['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="x_panel">
                                                                                    ...
                                                                                    <div class="x_content">
                                                                                        <br />
                                                                                        <form role="form" action="operaciones/editar_programacion_clases.php" class="form-horizontal form-label-left input_mask" method="POST">
                                                                                            <input type="hidden" name="data" value="<?php echo $rb_cursos_programados['id']; ?>">
                                                                                            <div class="form-group">
                                                                                                <div class="row">
                                                                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Curso : </label>
                                                                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                                                                        <input type="text" maxlength="20" class="form-control" readonly value="<?php echo $rb_curso['nombre'] . " - " . $rb_nivel['nombre'] . " - " . $rb_grado['nombre'] . " - " . $rb_seccion['nombre'] . " - " . $rb_turno['nombre']; ?>">
                                                                                                        <br>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                <div class="row">
                                                                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Docente : </label>
                                                                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                                                                        <select name="docente_m" id="docente_m" class="form-control">
                                                                                                            <option value=""></option>
                                                                                                            <?php
                                                                                                            $b_docente = buscar_docenteOrdenAp($conexion);
                                                                                                            while ($r_b_docente = mysqli_fetch_array($b_docente)) {
                                                                                                            ?>
                                                                                                                <option value="<?php echo $r_b_docente['id']; ?>" <?php if($rb_cursos_programados['id_docente']==$r_b_docente['id']){ echo "selected";} ?>><?php echo $r_b_docente['apellidos_nombres']; ?></option>
                                                                                                            <?php }
                                                                                                            ?>
                                                                                                        </select>
                                                                                                        <br>
