...
if ($enviar) {
    ...
    try {
        ...
        $mail->Username   = 'soporte@sie.cecitec.pe';                     //SMTP username
        $mail->Password   = 'eoArMdWO{F=B';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        $titulo_correo = 'SIE '.$r_b_datos_institucion['razon_social'];
        //Recipients
        $mail->setFrom('soporte@sie.cecitec.pe', $titulo_correo);
        ...
        $mail->Body = '<!DOCTYPE html>
                    ...
                    <div style="width: 100%; font-family: Roboto; font-size: 0.8em; display: inline;">
                        <div style="background-color:#CD1624; border-radius: 10px 10px 0px 0px; text-align: center;">
                            <img src="https://thumbs.dreamstime.com/z/un-libro-abierto-2505743.jpg" alt="" style="padding: 0.5em; text-align: center;" height="50px">
                        </div>
                        <div style="background-color:#CD1624; border-radius: 0px 0px 0px 0px; height: 60px; margin-top: 0px; padding-top: 2px; padding-bottom: 10px;">
                        ...
                        <div style="color: #f1f1f1; width: 100%; height: 120px; background:#CD1624; text-align: center;  border-radius: 0px 0px 10px 10px; ">
                            <br>
                            <p style="margin: 0px;">
                                <strong>
                                    <a"
                                    ...
                                    <br> '.$r_b_datos_institucion['razon_socila'].'
                                </strong>
                            </p>
                        </div>
                    </div>
